...
<div id="dashboard">
  ...
  <UserPanel @triggerModal="test()" :hideTrigger="false"></UserPanel>
  <b-modal id="modal-2" size="xl" title="" centered hide-header>
    <b-form @submit.prevent>
        <textarea v-if="!this.showTextImageCreator" ref="posttextarea" :rows="textareaRows" class="textarea mb-3" style="width:100%;" v-model.trim="post.content" placeholder="Lass deiner Fantasie freien lauf...." v-on:input="watchVideoUrl"></textarea>
    ...
    <template v-slot:modal-footer="{  }">
      <b-button  variant="light" @click="cancel_createPost()">
        Doch nicht
      </b-button>
      <b-button  variant="success" @click="createPost()"  :disabled="post.content === '' && post.textimage.text === ''">
        Beitrag erstellen
      </b-button>
    </template>
  </b-modal>
  <b-container fluid class="container-nogutter">
    <div class="pt-3" style="border-bottom: 1px solid #DEE2E6;">
    ...
    <div v-if="posts.length" class="mt-4">
      <masonry
        :cols="{default: 4, 1200: 3,1000:2, 500: 1, 400: 1}"
        :gutter="{default: '30px', 500: '15px'}"
        >
